  ...
  return (
    <nav className="fixed top-0 w-full bg-black/90 backdrop-blur-sm border-b border-gray-800 z-50">
      <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <Link 
          href="/" 
          className="text-xl font-light tracking-widest hover:text-gray-300 transition"
          onClick={closeMenu}
        >
          esjaythegreat
        </Link>
        ...
        <div className="hidden md:flex gap-8 text-sm tracking-wide">
          {currentPage === 'home' ? (
            ...
            <>
              ...
              <Link 
                href="/blog" 
                className={currentPage === 'blog' ? 'text-gray-300' : 'hover:text-gray-300 transition'}
              >
                blog
              </Link>
              <Link 
                href="/events" 
                className={currentPage === 'events' ? 'text-gray-300' : 'hover:text-gray-300 transition'}
              >
                events
              </Link>
              <Link 
                href="/contact" 
                className={currentPage === 'contact' ? 'text-gray-300' : 'hover:text-gray-300 transition'}
              >
                contact
              </Link>
            </>
        ...
        <div className="px-6 py-4 space-y-4 text-sm tracking-wide">
          {currentPage === 'home' ? (
            ...
            <>
              ...
              <Link 
                href="/blog" 
                className={`block ${currentPage === 'blog' ? 'text-gray-300' : 'hover:text-gray-300 transition'}`}
                onClick={closeMenu}
              >
                blog
              </Link>
              <Link 
                href="/events" 
                className={`block ${currentPage === 'events' ? 'text-gray-300' : 'hover:text-gray-300 transition'}`}
                onClick={closeMenu}
              >
                events
              </Link>
              <Link 
                href="/contact" 
                className={`block ${currentPage === 'contact' ? 'text-gray-300' : 'hover:text-gray-300 transition'}`}
                onClick={closeMenu}
              >
                contact
              </Link>
